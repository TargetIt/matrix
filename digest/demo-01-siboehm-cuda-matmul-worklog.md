...
> 基于 [siboehm 的工作日志](https://siboehm.com/articles/22/CUDA-MMM)，使用 M=N=K=16 的具体数值（整数矩阵，seed=1, randint -5..5），逐步推演每一步优化的原理与计算过程。
...
| 行 | 列 0-7 | 列 8-15 |
|----|--------|---------|
| 0 | 0, 3, 4, 0, -5, -5, -4, 2 | 1, 4, -3, -1, 0, -3, -1, 5 |
| 1 | -3, -1, 2, 2, 4, -4, 2, -5 | 1, 4, 4, 2, 1, 4, -4, -5 |
| 2 | -4, 3, 3, -2, 5, 4, 3, 2 | -2, 1, 0, -4, 4, -2, -1, 3 |
| 3 | -4, 5, -1, -5, -2, 4, -3, -5 | -1, 4, -3, 2, 2, 5, 4, 3 |
| 4 | 1, 4, -2, 2, 2, -1, 0, 4 | -2, 1, 3, -5, -3, 5, 2, 2 |
| 5 | 4, 2, -2, 5, -5, 3, 2, 2 | -4, -4, -2, -5, 3, 1, -1, 0 |
| 6 | 1, -3, 0, 2, 3, -1, -1, 2 | 2, -1, 4, -5, -3, -5, 5, 2 |
| 7 | -4, 2, 4, 3, 5, -1, -5, -4 | 4, 3, -3, -2, -4, -3, 2, -3 |
| 8 | 5, 1, -5, 4, -3, 1, 1, -3 | 2, 2, -5, 1, 0, -4, 5, -1 |
| 9 | 1, -5, 1, 0, -4, -3, -4, 0 | -1, 5, -5, 2, 3, 4, 0, 2 |
| 10 | -5, 4, -2, 4, -4, -1, -1, 1 | 3, 3, 4, -3, 2, 0, 0, -1 |
| 11 | 0, 3, 0, 3, -4, -4, 3, 2 | -5, 5, -2, -1, -3, -5, -2, 0 |
| 12 | -4, -3, -1, -2, -5, 1, -5, 2 | -3, 5, 3, -2, -5, 3, -1, -3 |
| 13 | 4, -5, -2, 3, -4, 5, -1, -2 | -2, 5, 1, 2, -2, 0, -2, -3 |
| 14 | -1, -1, -5, -2, -2, 3, -2, 0 | 1, 2, 0, -4, 2, -5, 5, 5 |
| 15 | -3, 3, -3, -4, -1, -5, -1, -4 | 2, -2, -4, 1, 1, 4, 5, 1 |

### 矩阵 B (16×16, float32)

| 行 | 列 0-7 | 列 8-15 |
|----|--------|---------|
| 0 | 4, 1, -5, -5, -3, 4, 1, -5 | 1, 2, -5, -2, 4, -5, -2, 5 |
| 1 | -1, 2, 0, -2, 3, 3, -5, 1 | 2, 4, 0, -1, 4, 5, 0, -3 |
| 2 | 0, 1, 1, 3, 5, 2, 2, 2 | -3, 1, -5, 0, -3, -4, 5, 3 |
| 3 | 0, 4, -1, 4, -4, -3, -5, 5 | -1, 2, -5, 1, -3, -1, -2, 1 |
| 4 | 2, 1, -2, -5, 1, -1, 2, 1 | -3, 5, 4, 5, 0, 4, 4, 4 |
| 5 | 3, 1, -1, -3, 5, 4, -1, -5 | -5, -2, 5, -1, 4, -2, 4, -4 |
| 6 | -3, 0, -1, -5, 3, -3, -2, 4 | 4, -1, -1, 3, -3, -4, 1, -2 |
| 7 | 3, 4, 2, -5, 0, -3, -3, 5 | 5, 5, 3, 0, 5, -5, 0, 4 |
| 8 | 3, 5, 1, 1, -5, -1, 2, -2 | -5, -4, 1, 5, -5, 1, -4, 1 |
| 9 | -1, -3, 0, -1, 1, -3, 4, -3 | 2, 0, -5, 2, 5, 3, 3, 3 |
| 10 | -5, 2, -3, -5, 2, -4, 5, -4 | 5, 4, 0, -4, 0, 4, 5, 1 |
| 11 | -1, 4, 3, 2, 5, 0, -4, 5 | 3, -5, 0, -2, 4, -5, -1, 3 |
| 12 | 1, -3, -1, -2, 5, -3, -5, -5 | -1, 5, 5, -3, 0, -5, -5, -2 |
| 13 | 3, 0, -2, -4, -1, 2, -2, -3 | -3, 5, -3, 1, 1, 5, -5, 5 |
| 14 | -4, 0, 5, 1, 0, 3, 3, 0 | 0, 2, 0, 4, -4, -2, 4, -2 |
| 15 | -2, -2, 1, -4, -2, -5, 0, -5 | 0, -3, 2, 1, -1, 5, -5, -3 |

### 预期结果 C = A @ B (16×16, float32) — Ground Truth

| 行 | 列 0-7 | 列 8-15 |
|----|--------|---------|
| 0 | -10, -19, 40, 57, -32, -27, 0, 2 | 22, -28, -55, -10, 9, 13, -44, -2 |
| 1 | -20, 1, -40, 17, 26, -39, 24, 23 | -6, 31, -62, 12, -27, 58, 24, 68 |
| 2 | -7, -33, -4, -71, 85, -34, -12, -22 | -16, 54, 83, 18, 8, 23, 52, -52 |
| 3 | -18, -60, 42, 7, 63, 56, -10, -89 | -50, -23, 30, 4, 41, 86, -17, -63 |
| 4 | -4, 10, -25, -86, -44, -10, 6, -14 | 32, 105, -23, 21, 26, 95, 7, 27 |
| 5 | 30, -9, -41, -25, -19, 22, -92, -14 | 8, 52, -8, -49, 16, -58, -59, -47 |
| 6 | -31, 19, 8, -12, -67, -32, 89, -6 | 6, 19, 10, 44, -67, 16, 65, -5 |
| 7 | 3, 19, 33, 109, -33, 33, 57, 44 | -87, -18, -35, 76, -59, 70, 71, 9 |
| 8 | 2, 4, 16, 48, -55, 38, -24, -1 | -5, -56, -35, 27, -6, -59, -33, -40 |
| 9 | 30, -50, 22, 50, -27, -10, -7, -33 | -20, -24, -56, -8, 21, -29, -82, 50 |
| 10 | -36, 14, 10, 24, -18, -53, -17, -4 | 23, 32, -6, -8, -17, 62, -14, -39 |
| 11 | -45, -21, 11, 35, -7, -36, -23, 84 | 97, -14, -78, -16, 37, -17, 23, -14 |
| 12 | -12, -26, 12, 34, -15, 6, 65, -15 | 25, -6, -37, -34, 52, 60, 51, 23 |
| 13 | 19, -6, -35, 22, -8, 19, 22, -37 | 3, -50, -64, -41, 60, -46, 22, 27 |
| 14 | -30, -48, 32, -13, -28, -24, 42, -89 | -3, -33, 75, 13, -10, 23, -1, -94 |
| 15 | -23, -31, 50, 38, -26, 34, -13, -7 | -24, -16, 17, 38, -49, 61, -71, -35 |
...
```
Part1[0,0] =  -3   (bk_start=0, 列 0-3,   加载到 SMEM)
Part2[0,0] =  -7   (bk_start=4, 列 4-7,   从 GMEM 加载下一 tile 到 SMEM)
Part3[0,0] =  15   (bk_start=8, 列 8-11,  从 GMEM 加载下一 tile 到 SMEM)
Part4[0,0] = -15   (bk_start=12, 列 12-15, 从 GMEM 加载下一 tile 到 SMEM)
────────────────────────
C[0,0]     = -10 ✓
```
...
```
C[0,1]: Part1=10  + Part2=-2  + Part3=-17 + Part4=-10 = -19 ✓
C[0,2]: Part1=4   + Part2=23  + Part3=7   + Part4=6   =  40 ✓
C[0,3]: Part1=6   + Part2=50  + Part3=10  + Part4=-9  =  57 ✓
```

**不同 Block 的独立计算示例 — C[1,0]：**

```
Part1[1,0] = -11   (bk_start=0, SMEM tile 0)
Part2[1,0] = -25   (bk_start=4, SMEM tile 1)
Part3[1,0] = -23   (bk_start=8, SMEM tile 2)
Part4[1,0] =  39   (bk_start=12, SMEM tile 3)
────────────────────────
C[1,0]     = -20 ✓
```
...
GPU 的 共享内存 (SMEM) 支持 128-bit（即 `float4`）的加载/存储指令。这意味着可以用一条指令从 SMEM 加载 4 个连续的 float，而不是 4 条独立指令。
...
**为什么向量化有效？** 共享内存 (SMEM) 有多个 bank（32 个），bank 冲突会序列化访问。使用 128-bit 加载可以减少指令数（指令发射压力），同时编译器可以更好地调度指令隐藏延迟。在我们的 demo 中（BK=4），As 的每一行自动就是 4 个连续的 float——天然适合 `float4` 加载，一条指令将 4 个 float 从 全局内存 (GMEM) 加载到 SMEM。

### 7.3 在 16×16 demo 中的体现

对于 BK=4，As 的每行恰好是 4 个 float，一次 `float4` 从 GMEM 加载到 SMEM：
```
As[0] = {0, 3, 4, 0}  ← 一次 float4 加载 (GMEM → SMEM)
```
...
一个 Block 内的线程进一步按 Warp 组织。Warp（32 线程）可以协作加载数据到寄存器，进一步减少对 共享内存 (SMEM) 的访问。

**策略**：
1. 将 Block 的工作按 Warp 划分
2. 每个 Warp 负责 C 的一个子区域
3. Warp 内的线程协作加载数据，最大化数据在寄存器中的复用
...
│ C[0:4, 0:4]           │ C[0:4, 4:8]           │
│                       │                       │
│  -10  -19   40   57   │  -32  -27    0    2   │
│  -20    1  -40   17   │   26  -39   24   23   │
│   -7  -33   -4  -71   │   85  -34  -12  -22   │
│  -18  -60   42    7   │   63   56  -10  -89   │
├───────────────────────┼───────────────────────┤
│ Thread (1,0)          │ Thread (1,1)          │
│ C[4:8, 0:4]           │ C[4:8, 4:8]           │
│                       │                       │
│   -4   10  -25  -86   │  -44  -10    6  -14   │
│   30   -9  -41  -25   │  -19   22  -92  -14   │
│  -31   19    8  -12   │  -67  -32   89   -6   │
│    3   19   33  109   │  -33   33   57   44   │
└───────────────────────┴───────────────────────┘
```

4 个"逻辑线程"（每 warp 内 WMIter×WNIter=4），每个计算 4×4=16 个 C 元素，结果全部在寄存器中累积。

### 8.4 从第一性原理分析

**为什么 Warp tiling 有效？** 在较新的 GPU 架构（Volta+）上，warp 内的线程可以通过 `__shfl_sync` 等 warp 级原语直接在寄存器间交换数据，完全绕过 共享内存 (SMEM)。这可以将每个 FMA 的 SMEM 访问次数降到接近 0——数据只需从 全局内存 (GMEM) 加载一次到 warp 的寄存器文件中，然后在 warp 内广播。这是接近 cuBLAS 性能的关键技术。原始文章达到 21.8 TFLOPs（93.7% of cuBLAS）。

**内存层次总结（Kernel 10）：**
- **全局内存 (GMEM) reads**: 4096 bytes
- **全局内存 (GMEM) writes**: 1024 bytes
- **共享内存 (SMEM) writes**: 4096 bytes（协同加载）
- **共享内存 (SMEM) reads**: ~32768 bytes
- **关键提升**: BK=8 意味着更大的 K-tile，每个 tile 做更多计算后才从 GMEM 加载新数据
...
| 6 Vectorized | float4 SMEM 加载 | 减少指令数，提高 SMEM 吞吐 | SMEM 指令效率↑ | 78.4% |
| 10 Warptiling | Warp 级协作 + 寄存器复用 | warp shuffle 绕过 SMEM，数据在寄存器中广播 | 近零 SMEM 访问 | 93.7% |
...
4. **渐进式优化是理解系统的唯一方法**：每一步优化（30%-100% 提升）都揭示了一个硬件特性：
   ...
   - Warp 级协作 → 寄存器间通信完全绕过 SMEM

> **验证说明**：本文所有数值计算均可通过配套 Python 脚本 `demo-01-siboehm-cuda-matmul-worklog.py` 复现。脚本使用 `numpy.random.seed(1)` 和 `np.random.randint(-5, 6, (16,16)).astype(np.float32)` 生成整数矩阵，并逐步验证每个 Kernel Stage 的输出与 numpy `@` 运算符的结果一致（最大误差 = 0，全部 PASS）。
